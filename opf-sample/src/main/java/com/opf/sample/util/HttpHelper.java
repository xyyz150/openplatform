...
public class HttpHelper {
    ...
    private static HttpURLConnection getConnection(URL url, String method, String ctype, Map<String, String> headerMap) throws Exception {
        HttpURLConnection conn = null;
