 ...
 */
public class SropUtils {
    protected static Logger logger = LoggerFactory.getLogger(SropUtils.class);

    public static MessageFormat getFormat(HttpServletRequest request) {
        String format = SropUtils.urlDecode(request.getParameter(SystemParameterNames.getFormat()));
