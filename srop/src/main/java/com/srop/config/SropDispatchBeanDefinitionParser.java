...
import com.srop.router.SropDispatchRouterFactoryBean;
import com.srop.security.DefaultAppSecretManager;
import com.srop.security.DefaultInvokeManager;
 ...
 * @version 1.0
 */
public class SropDispatchBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        RootBeanDefinition serviceRouterDef = new RootBeanDefinition(SropDispatchRouterFactoryBean.class);
